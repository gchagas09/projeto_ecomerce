    ...
    <div class="slider-area">
			...
			<div class="block-slider block-slider4">
				<ul class="" id="bxslider-home4">
					<li>
						<img src="/res/img/h4-slide.png" alt="Slide">
					...
					<li><img src="/res/img/h4-slide2.png" alt="Slide">
						<div class="caption-group">
							<h2 class="caption title">
					...
					<li><img src="/res/img/h4-slide3.png" alt="Slide">
						<div class="caption-group">
							<h2 class="caption title">
					...
					<li><img src="/res/img/h4-slide4.png" alt="Slide">
						<div class="caption-group">
						  <h2 class="caption title">
								Apple <span class="primary">Store <strong>Ipod</strong></span>
							</h2>
                ...
                <div class="col-md-12">
                    <div class="brand-wrapper">
                        <div class="brand-list">
                            <img src="/res/img/brand1.png" alt="">
                            <img src="/res/img/brand2.png" alt="">
                            <img src="/res/img/brand3.png" alt="">
                            <img src="/res/img/brand4.png" alt="">
                            <img src="/res/img/brand5.png" alt="">
                            <img src="/res/img/brand6.png" alt="">
                            <img src="/res/img/brand1.png" alt="">
                            <img src="/res/img/brand2.png" alt="">                            
                        </div>
                    </div>
